...
plt.plot(periodic, label='Periodic (sync = 1000)')
plt.plot(soft_updates, label='Soft Updates (tau = 0.005)')
plt.title('Cartpole-V1 R100 against Episode for Period and Soft Updates')
plt.xlabel('Episode')
plt.ylabel('R100')
plt.legend()
plt.grid(True)
plt.savefig('results/cartpole-soft-period.png')
plt.show()
